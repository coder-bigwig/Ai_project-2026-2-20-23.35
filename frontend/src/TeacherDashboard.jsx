...
const TEACHER_ACTIVE_TAB_KEY_PREFIX = 'teacherDashboardActiveTab';
...
function getTeacherActiveTabKey(username, isAdmin) {
  return `${TEACHER_ACTIVE_TAB_KEY_PREFIX}:${String(username || '').trim() || 'anonymous'}:${isAdmin ? 'admin' : 'teacher'}`;
}
...
function TeacherDashboard({ username, userRole, onLogout }) {
  ...
  const [resourceInitialCourseId, setResourceInitialCourseId] = useState('');
  const [resourceInitialCourseOpenKey, setResourceInitialCourseOpenKey] = useState(0);
  ...
  }, [activeTab, defaultActiveTab, tabs]);
  ...
  const handleOpenCourseResources = (course) => {
    const courseId = String(course?.id || '').trim();
    if (!courseId) return;
    setResourceInitialCourseId(courseId);
    setResourceInitialCourseOpenKey((value) => value + 1);
    ...
    <div className="teacher-lab-shell">
      <header className="teacher-lab-topbar">
        ...
        <div className="teacher-lab-user">
          ...
          <button type="button" className="teacher-lab-jhub teacher-lab-jhub-tutor" onClick={openDeepTutor}>进入 DeepTutor</button>
          ...
          {activeTab === 'courses' ? (
            <>
              ...
              <CoursePanel
                ...
                onOpenCourseResources={handleOpenCourseResources}
          ...
          {activeTab === 'resources' ? (
            <div className="teacher-lab-section">
              <ResourceFileManagement
                username={username}
                userRole={userRole}
                initialCourseId={resourceInitialCourseId}
                initialCourseOpenKey={resourceInitialCourseOpenKey}
              />
            </div>
          ) : null}
            ...
            return (
              <article className="teacher-lab-card" key={course.id}>
                ...
                <div className="teacher-lab-card-actions">
                  ...
                  <button type="button" className="teacher-lab-btn" onClick={() => onOpenCourseResources(course)}>{'\u8bfe\u7a0b\u8d44\u6599'}</button>
  ...
  return (
    <div className="teacher-lab-course-section">
      ...
      <div className="teacher-lab-course-tools">
        ...
        <button type="button" className="teacher-lab-btn" onClick={() => onOpenCourseResources(selectedCourse)}>{'\u8bfe\u7a0b\u8d44\u6599'}</button>
